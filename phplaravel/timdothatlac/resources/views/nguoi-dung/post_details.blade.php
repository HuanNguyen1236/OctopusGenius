        ...
        <div class="row gy-4">
            ...
            <div class="portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                ...
                <div class="swiper-slide">
                  <img src="{{ url('public/Image/'.$post->hinh_anh) }}" alt="">
                </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              <h3>{{$post->tieu_de}}</h3>
              <ul>
                <li><strong>Loại đô vật</strong>: {{$post->loai_bai_post}}</li>
                <li><strong>Địa chỉ</strong>: {{$post->dia_chi}}</li>
                <li><strong>Liên hệ</strong>: <a href="#">{{$post->email}}</a> hoặc <strong>SĐT</strong>: {{$post->sdt}}</li>
              </ul>
            </div>
